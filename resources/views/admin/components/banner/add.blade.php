...
@section('content')
    @include('admin.partials.page-breadcrumb', ['key' => 'Banner', 'name' => 'Add'])
        ...
        <div class="col-12 mx-auto">
            <form action="{{ route('admin.banner.store') }}" method="post" enctype="multipart/form-data">
                ...
                <!-- Validate End -->
                    ...
                    <!-- Notification Start -->
                @include('admin.partials.flash-message', ['name_success' => 'banner_add_success_message', 'name_error' => 'banner_add_error_message'])
                <!-- Notification End -->
                    <div class="card-body">
                        <div class="mb-3">
