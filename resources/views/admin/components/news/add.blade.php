...
@section('content')
    @include('admin.partials.page-breadcrumb', ['key' => 'Tin tức', 'name' => 'Add'])
        ...
        <div class="col-12 mx-auto">
            <form action="{{ route('admin.news.store') }}" method="post" enctype="multipart/form-data">
                ...
                <!-- Validate End -->
                    ...
                    <!-- Notification Start -->
                @include('admin.partials.flash-message', ['name_success' => 'news_add_success_message', 'name_error' => 'news_add_error_message'])
                <!-- Notification End -->
                    <div class="card-body">
                        <div class="mb-3">
