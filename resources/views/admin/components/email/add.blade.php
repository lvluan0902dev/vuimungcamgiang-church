...
@section('content')
    @include('admin.partials.page-breadcrumb', ['key' => 'Email', 'name' => 'Add'])
        ...
        <div class="col-12 mx-auto">
            <form action="{{ route('admin.email.store') }}" method="post">
                ...
                <!-- Validate End -->
                    ...
                    <!-- Notification Start -->
                @include('admin.partials.flash-message', ['name_success' => 'email_add_success_message', 'name_error' => 'email_add_error_message'])
                <!-- Notification End -->
                    <div class="card-body">
                        <div class="mb-3">
