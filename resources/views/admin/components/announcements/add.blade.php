...
@section('content')
    @include('admin.partials.page-breadcrumb', ['key' => 'Thông báo', 'name' => 'Add'])
        ...
        <div class="col-12 mx-auto">
            <form action="{{ route('admin.announcements.store') }}" method="post" enctype="multipart/form-data">
                ...
                <!-- Validate End -->
                    ...
                    <!-- Notification Start -->
                @include('admin.partials.flash-message', ['name_success' => 'announcements_add_success_message', 'name_error' => 'announcements_add_error_message'])
                <!-- Notification End -->
                    <div class="card-body">
                        <div class="mb-3">
