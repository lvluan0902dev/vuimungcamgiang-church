...
@section('content')
    @include('admin.partials.page-breadcrumb', ['key' => 'Số điện thoại', 'name' => 'Add'])

    <div class="row">
        <div class="col-12 mx-auto">
            <form action="{{ route('admin.phone-number.store') }}" method="post">
                @csrf
                <div class="card">
                    <!-- Validate Start -->
                ...
                <!-- Validate End -->
                    ...
                    <!-- Notification Start -->
                @include('admin.partials.flash-message', ['name_success' => 'phone_number_add_success_message', 'name_error' => 'phone_number_add_error_message'])
                <!-- Notification End -->
                    <div class="card-body">
                        <div class="mb-3">
