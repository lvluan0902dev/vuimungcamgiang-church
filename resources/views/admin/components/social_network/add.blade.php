...
@section('content')
    @include('admin.partials.page-breadcrumb', ['key' => 'Mạng xã hội', 'name' => 'Add'])

    <div class="row">
        <div class="col-12 mx-auto">
            <form action="{{ route('admin.social-network.store') }}" method="post">
                @csrf
                <div class="card">
                    <!-- Validate Start -->
                ...
                <!-- Validate End -->
                    ...
                    <!-- Notification Start -->
                @include('admin.partials.flash-message', ['name_success' => 'social_network_add_success_message', 'name_error' => 'social_network_add_error_message'])
                <!-- Notification End -->
                    <div class="card-body">
                        <div class="mb-3">
