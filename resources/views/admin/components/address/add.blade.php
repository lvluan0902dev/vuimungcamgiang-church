...
@section('content')
    @include('admin.partials.page-breadcrumb', ['key' => 'Địa chỉ', 'name' => 'Add'])
        ...
        <div class="col-12 mx-auto">
            <form action="{{ route('admin.address.store') }}" method="post">
                ...
                <!-- Validate End -->
                    ...
                    <!-- Notification Start -->
                @include('admin.partials.flash-message', ['name_success' => 'address_add_success_message', 'name_error' => 'address_add_error_message'])
                <!-- Notification End -->
                    <div class="card-body">
                        <div class="mb-3">
